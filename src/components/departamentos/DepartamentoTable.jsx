import { Edit, Trash2, Building2, Hash, Layers } from 'lucide-react';
            ...
            {departamentos.length > 0 ? (
              departamentos.map((dep) => (
                <tr key={dep.id} className="hover:bg-gray-50 transition-colors group">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border ${getAreaBadgeClass(dep.area_general)}`}>
